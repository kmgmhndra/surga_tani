...
class DetailHortikulturaScreen extends StatefulWidget {
  final PencatatanHortikultura pencatatan;
  final int pencatatanKey;

  const DetailHortikulturaScreen({
    super.key,
  ...
  @override
  State<DetailHortikulturaScreen> createState() =>
      _DetailHortikulturaScreenState();
}

class _DetailHortikulturaScreenState extends State<DetailHortikulturaScreen> {
  ...
  late List<HortikulturaEditData> _komoditiEditList;
  List<dynamic> _images = [];
  final ImagePicker _picker = ImagePicker();

  // Constants
  static const Color _primaryColor =
      Color(0xFFF57C00); // Warna tema Hortikultura (Oranye)
  ...
  Future<void> _updateData() async {
    ...
    final updatedPencatatan = PencatatanHortikultura()
    ...
    if (mounted) {
      ...
      showTopSnackBar(
        ...
        const CustomSnackBar.success(
          message: "Data Hortikultura berhasil diperbarui!",
        ),
      );
