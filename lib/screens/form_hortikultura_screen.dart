...
class HortikulturaFormData {
  final String nama;
  final bool isDefault;
  final TextEditingController hargaController = TextEditingController();
  final TextEditingController keteranganController = TextEditingController();
  HortikulturaFormData({required this.nama, this.isDefault = false});
}

class FormHortikulturaScreen extends StatefulWidget {
  const FormHortikulturaScreen({super.key});

  @override
  State<FormHortikulturaScreen> createState() => _FormHortikulturaScreenState();
}

class _FormHortikulturaScreenState extends State<FormHortikulturaScreen> {
  ...
  late List<HortikulturaFormData> _komoditiItems;

  // Constants
  static const Color _primaryColor =
      Color(0xFFFF8F00); // Warna tema Hortikultura (Oranye)
  ...
  List<HortikulturaFormData> _getDefaultCommodities() {
    const defaultNames = [
      'Bawang Merah',
      'Bawang Putih',
      'Cabai Besar',
    ...
    return defaultNames
        .map((nama) => HortikulturaFormData(nama: nama, isDefault: true))
        .toList();
  }
  ...
  Future<void> _saveData() async {
    ...
    try {
      ...
      final newPencatatan = PencatatanHortikultura()
      ...
      final box = Hive.box('hortikultura_box');
      ...
      if (mounted) {
        ...
        showTopSnackBar(
          ...
          const CustomSnackBar.success(
              message: "Data Hortikultura berhasil disimpan!"),
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: GradientAppBar(
        title: 'Catat Harga',
        subtitle: 'Hortikultura',
        icon: MdiIcons.carrot,
        gradientColors: const [
          Color(0xFF663900), // Warna paling gelap
          Color(0xFFB36200), // Warna pertengahan
          Color(0xFFFF8F00), // Warna asli
        ],
      ),
      body: Form(
        key: _formKey,
